...
public class Edit_customer_activity extends Activity {
    ...
    EditText mAddress;
    @BindView(R.id.edit_customer_street)
    EditText mAddressStreet;
    @BindView(R.id.edit_customer_post_office)
    EditText mAddressPostOffice;
    @BindView(R.id.edit_customer_neighborhood)
    EditText mAddressNeighbourHood;
    @BindView(R.id.edit_customer_zipcode)
    EditText mAddressZipcode;
    @BindView(R.id.edit_customer_city)
    EditText mAddressCity;
    @BindView(R.id.edit_customer_state)
    EditText mAddressState;
    //name ui element
    @BindView(R.id.edit_customer_first_name)
    EditText mName;
    @BindView(R.id.edit_customer_middle_name)
    EditText mMiddleName;
    @BindView(R.id.edit_customer_last_name)
    EditText mLastName;
    @BindView(R.id.edit_customer_suffix_name)
    EditText mSuffixName;
    @BindView(R.id.edit_customer_family_name)
    EditText mFamilyName;
    //Phone number ui element
    @BindView(R.id.edit_customer_phon)
    EditText mPhoneNumber;
    @BindView(R.id.edit_customer_phon_spinner)
    Spinner mPhoneSpinner;
    //Email Ui element
    @BindView(R.id.edit_customer_mail)
    EditText mEmailAddress;
    @BindView(R.id.edit_customer_mail_spinner)
    Spinner mEmailSpinner;
    //FLoating action buttom
    @BindView(R.id.edit_customer_floating_action_buttom)
    FloatingActionButton mFloatingActionBottom;
