    ...
    private void setData() {
        ...
        //set Name
         ...
         if(employee.getMail() != null ) {
             if(employee.getMail().getValue() != null ) mEmail.setText(employee.getMail().getValue());
             if(employee.getMail().getSub() != null) mEmailType.setText(employee.getMail().getSub());
         }
         //Set Date of birth and Date of join (can be nullable)
         if(employee.getDateOfJoin() != null) mDateOfJoin.setText(employee.getDateOfJoin().toString());
         if(employee.getDateOfBirth() != null) mDateOfBirth.setText(employee.getDateOfBirth().toString());
         //set phone number type(can be nullable)
        if(employee.getPhoneNumber() != null ) {
            if(employee.getPhoneNumber().getValue() != null) mPhoneNumber.setText(employee.getPhoneNumber().getValue());
            if(employee.getPhoneNumber().getSub() != null ) mPhoneNumberType.setText(employee.getPhoneNumber().getSub());
        }
        //set Address can be nullable
        if(employee.getAddress() != null) {
           if(employee.getAddress().getAddress() != null) setAddressHelper(employee.getAddress().getAddress(), address);
           if(employee.getAddress().getCity() != null ) setAddressHelper(employee.getAddress().getCity(), city);
           if(employee.getAddress().getState() != null) setAddressHelper(employee.getAddress().getState(), state);
           if(employee.getAddress().getNeighborhood() != null) setAddressHelper(employee.getAddress().getNeighborhood(), neighbourhood);
           if(employee.getAddress().getStreet() != null) setAddressHelper(employee.getAddress().getStreet(), street);
           if(employee.getAddress().getZipcode() != null) setAddressHelper(employee.getAddress().getZipcode(), zipcode);
